...
(function(){
  ...
  var INTERNAL_KEYS = ["__location", "__scopes", "__scopeName", "__identifiers", "__parentScope", "__contextMapping"];
  ...
  TracingResults.prototype.contextFor = function(variableName) {    
    return this.results.__contextMapping[variableName];
  }
